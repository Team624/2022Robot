...
public class VisionTurn extends CommandBase {
  ...
  public void execute() {
    ...
    double errorA = getQuickTurnValue()
  ...
  private double getRotationPID(double wantedDeltaAngle) {
    return m_drivetrainSubsystem.visionTurn_pid.calculate(m_drivetrainSubsystem.getGyroscopeRotation().getDegrees(),
  ...
  private double getVisionPID(double wantedDeltaAngle) {
    return m_drivetrainSubsystem.visionTurn2_pid.calculate(m_drivetrainSubsystem.getGyroscopeRotation().getDegrees(),
        m_drivetrainSubsystem.getGyroscopeRotation().getDegrees() + wantedDeltaAngle);
  }

  private double getQuickTurnPID(double wantedAngle) {
    return m_drivetrainSubsystem.visionTurn_pidQuickTurn
        .calculate(m_drivetrainSubsystem.getGyroscopeRotation().getDegrees(), wantedAngle);
  }
