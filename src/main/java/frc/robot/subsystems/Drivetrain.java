...
public class Drivetrain extends SubsystemBase {
        ...
        public void periodic() {
                ...
                if (isAuton) {
                        ...
                        m_odometry.update(getGyroscopeRotation(), getState(m_frontLeftModule),
                                        getState(m_frontRightModule), getState(m_backLeftModule),
        ...
        private PIDController getAutonRotationPID() {
                return new PIDController(Constants.Drivetrain.visionP, Constants.Drivetrain.visionI,
                                Constants.Drivetrain.visionD);
        }
